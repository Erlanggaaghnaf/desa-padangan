...
<section class="bg-[#F7F9FC] pt-32 pb-12 px-4 md:px-8 lg:px-[120px]">
    <h1 class="text-3xl md:text-5xl font-extrabold text-[#172033] mb-4">Informasi Desa</h1>
    <p class="text-gray-500 text-sm md:text-base max-w-2xl">Mengenal lebih dekat sejarah, visi misi, letak geografis, dan struktur pemerintahan Desa Padangan.</p>
...
<main class="px-4 md:px-8 lg:px-[120px] py-12 space-y-24">
    ...
    <section class="flex flex-col md:flex-row gap-10 items-start">
        <div class="w-full md:w-5/12 flex-shrink-0 relative">
            <!-- Frame Foto Sejarah -->
    ...
    <!-- 2. VISI & MISI -->
    <section class="bg-[#F7F9FC] py-12 px-6 md:px-12 rounded-3xl border border-gray-100 shadow-sm">
    ...
    <div class="flex justify-between items-center w-full mt-8 gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
            <!-- Card Visi -->
            <div class="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col justify-start items-center h-full">
    ...
    <section>
        ...
        <div class="flex flex-col lg:flex-row gap-8 items-stretch">
            ...
            <div class="w-full lg:w-1/3 flex flex-col gap-4">
                ...
                <!-- Luas Area -->
                <div class="bg-[#2F855A]/10 p-4 rounded-xl border border-gray-100 flex gap-4 items-center">
                ...
                <!-- Batas Wilayah -->
                <div class="bg-[#2F855A]/10 p-4 rounded-xl border border-gray-100 flex gap-4 items-start">
                    <div class="bg-white p-3 rounded-lg shadow-sm text-[#2F855A]">
            ...
            <!-- Gambar Peta (Kanan) -->
            <div class="w-full lg:w-2/3 min-h-[350px] lg:min-h-[400px] rounded-3xl overflow-hidden shadow-sm border border-gray-200 relative">       
                <iframe 
    ...
    <section>
        <div class="text-center mb-10">
            <h2 class="text-2xl md:text-3xl font-bold text-[#172033] mb-2">SOTK DESA PADANGAN</h2>
            <p class="text-gray-500 text-sm md:text-base">Struktur Organisasi Tata Kerja Pemerintahan Desa Padangan</p>
        </div>

        <!-- Bagan Struktur (Gambar) -->
        <div class="bg-white p-4 md:p-8 rounded-3xl shadow-sm border border-gray-100 mb-12 flex justify-center">
